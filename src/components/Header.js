    ...
    return (
        <header className="flex items-center justify-between bg-gray-800">
            ...
            <div className="h-full w-full flex items-center justify-end font-bold">
                <button className="p-4 h-full text-white hover:bg-gray-700">Dashboard</button>
                <button className="p-4 h-full text-white hover:bg-gray-700">Queue</button>
                <button className="p-4 h-full text-white hover:bg-gray-700">Appointments</button>
